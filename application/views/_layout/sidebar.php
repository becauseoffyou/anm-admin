...
<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="dashboard">
        <div class="sidebar-brand-icon">
            <img src="<?= base_url('assets/'); ?>img/iconsdb.png">
        </div>
        <div class="sidebar-brand-text mx-3"><img width="100" src="<?= base_url('assets/'); ?>img/logo/animate-logo.png"></div>
    </a>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?= base_url('element/datatable/1'); ?>">Banner</a>
                <a class="collapse-item" href="<?= base_url('element/datatable/2'); ?>">Model</a>
                <a class="collapse-item" href="<?= base_url('element/datatable/4'); ?>">Treatment</a>
                <a class="collapse-item" href="<?= base_url('element/datatable/3'); ?>">Product</a>
                <hr class="sidebar-divider">
                <a class="collapse-item" href="<?= base_url('element/datatable/'); ?>">Article</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseTransaction" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Transaction</h6>
                <a class="collapse-item" href="<?= base_url('element/datatable'); ?>">Treatment</a>
                <a class="collapse-item" href="<?= base_url('element/datatable'); ?>">Product</a>
            </div>
        </div>
    </li>
    ...
    <hr class="sidebar-divider">
    <div class="version" id="version-animate"></div>
</ul>
<!-- Sidebar -->